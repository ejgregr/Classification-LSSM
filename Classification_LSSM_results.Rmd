...
## Mapped clusters
```{r mapplots, results='asis', echo=FALSE, fig.cap="Spatial distrubiton of clusters in July and December.", fig.width=7, fig.height=8, fig.align='center', out.extra='keepaspectratio', fig.pos='H'}
( jul_map / dec_map )
